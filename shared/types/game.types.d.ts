...
export type ResultReason = 'CHECKMATE' | 'TIMEOUT' | 'RESIGN' | 'STALEMATE' | 'DRAW_AGREED' | 'INSUFFICIENT_MATERIAL' | 'THREEFOLD_REPETITION' | 'FIFTY_MOVE_RULE';
...
export declare const DEFAULT_TIME_CONTROL: TimeControl;
