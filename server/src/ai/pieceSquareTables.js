...
exports.getPstBonus = getPstBonus;
/**
...
const SQUARE_INDEX = new Map(ALL_SQUARES.map((sq, i) => [sq, i]));
/**
 * Returns the PST bonus for a piece on a given square.
 * For Black, the table is mirrored vertically.
 */
function getPstBonus(pieceType, color, square, isEndgame) {
...
//# sourceMappingURL=pieceSquareTables.js.map